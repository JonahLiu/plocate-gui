...
CTRL+G""")
        ...
        self.open_file_btn.setIcon(QIcon.fromTheme("document-open-symbolic"))
        ...
        self.open_path_btn.setIcon(QIcon.fromTheme("folder-open-symbolic"))
        ...
        self.open_in_terminal_btn.setIcon(QIcon.fromTheme("utilities-terminal-symbolic"))
